...
# Let's try to find strings that have:
# (not uppercase)(3 uppercase)(1 lowercase)(3 uppercase)(not uppercase)
d.scan(/(?<![A-Z])[A-Z]{3}[a-z][A-Z]{3}(?![A-Z])/)
...
# Let's see them incontext:

# 89:GdqIQNlQSLidbDlqpdhoRbHrrUAgyhMgkZKYVhQuIACQpKjhmXbQCkrssyUHaKXgvNNMpadUjfnJYuWu
#       IQNlQSL
# 225:cZoExqHxUzeOEKiVEYjRkeiQyLXLRUAiPPviwCyNaOzenFIkNDxKMcKanMNLNVrYociOBCVoqQPgsrpT
#                OEKiVEY            
# 287:BzyzVTaCqEAAqibouxrHnJAudAAgVJYxwaZADnMCZqTiPwMrMKThramDajoDliFFxZSVlgLLZOZRUvJL
#                                       ZADnMCZ
# 387:vDRDIheKQYWtfiNCZsvXcqRxnZxgkrOewaebZUTkLYNgoJyOywInOdOoxsIvjBqCKDhyqjAzyQZdTgmA
#                                         ZUTkLYN
# 470:FGUKqobVUBVISShWwgHTVmvwxctgIdZgwanLBxAgWlPKloeRfEaFlakFuCNDeHSBjgsgAQGYHMVPjygW
#                                                              CNDeHSB
# 610:EjxOlVbstNygxFoOZHzpMswcxsxsZkSDoARNJLqnQGWnkOIXdKBFhFJqqwRrasvDcGYzSDnOOLPPkats
#                                                  OIXdKBF
# 623:DRKojHtwTJdYGQtsMGSHoKdpdFmZkiVjoiUpcJySJQqmKkXLSgTBxKNTqclTeWhvZUopRZdXJVlGZVme
#                                                                            XJVlGZV
# 1049:DDRBeXSmMNrHVQWysdqwpKAIYyiYlVjjWjoAPQABdicNUnceTuPwaqNkGMpgRBMMDFAgZAGiLQZxKpKh
#                                                                          ZAGiLQZ
# 1076:GnygjjbCsHXNwBvRSSajMMpnBwYbUeQADjvCJAsACFlCTLIQlAIVMTqHFkswqbDDHtpgcWaXSSglUYKE
#
# 1179:qKWGtIDCjnQyLfMuaaUCYJBblQAsSBNSMHLcrQxhDkyqDLtpqjoFzRaOyIvCoOhqZewHMfmCYkXDRsSE
#       KWGtIDC
#
# Nothing to see here
#
# A hint from stackoverflow:
#
# > And how come your answer includes big letters? Your answer should only include
# small letters.
#
# Let's return only the small letter

puts d.scan(/(?<![A-Z])[A-Z]{3}([a-z])[A-Z]{3}(?![A-Z])/).join
